...
import UIKit
@IBDesignable
open class CustomeSegmentedControl: UIView {
    
    //Version: 0.4.10
    //Configure the options to for a custom design
    @IBInspectable open var defaultTextFont: UIFont = UIFont.helveticaNeueLight(17)
    @IBInspectable open var selectedTextFont: UIFont = UIFont.helveticaNeueLight(17)
    ...
    @IBInspectable open var containerBackgroundColor: UIColor = CustomeSegmentedControl.UIColorFromRGB(0xF4F4F4)
    @IBInspectable open var thumbColor: UIColor = UIColor.clear
    @IBInspectable open var thumbGradientColors: [UIColor]? = [UIColor(named: "ButtonColor")!,UIColor(named: "ButtonColor")!]
    @IBInspectable open var thumbShadowColor: UIColor = CustomeSegmentedControl.UIColorFromRGB(0x9B9B9B)
...
extension CustomeSegmentedControl {
