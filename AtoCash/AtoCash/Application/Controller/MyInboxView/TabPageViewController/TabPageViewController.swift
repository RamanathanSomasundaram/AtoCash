...
protocol TabPageViewControllerDelegate : NSObjectProtocol {
...
open class TabPageViewController: UIPageViewController {
    ...
    weak var currentIndexDelegate : TabPageViewControllerDelegate?
...
extension TabPageViewController {
    ...
    fileprivate func configuredTabView() -> TabView {
        ...
        tabView.buttoncurrentindex = self
...
extension TabPageViewController: UIScrollViewDelegate {
    ...
    public func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        ...
        tabView.updateCurrentIndex(beforeIndex, shouldScroll: true)
        let item = tabItems[beforeIndex] as (viewController: UIViewController, title: String)
        self.currentIndexDelegate?.Tabpageviewcontroller(currentindex: beforeIndex, viewcontroller: item.viewController)

    }
}
extension TabPageViewController: TabViewDelegate{
    func Tabviewbuttontap(currentIndex: Int) {
        
        let item = tabItems[currentIndex] as (viewController: UIViewController, title: String)
        self.currentIndexDelegate?.Tabpageviewcontroller(currentindex: currentIndex, viewcontroller: item.viewController)

    }
    
    func ViewConrollerForIndex(index: Int) -> UIViewController
    {
        let item = tabItems[index] as (viewController: UIViewController, title: String)
