...
internal class TabView: UIView {
    ...
    weak var buttoncurrentindex : TabViewDelegate?
    ...
    func tabviewLabelUpdate(LabelText : String , index : Int)
    {
        pageTabItems.remove(at: index)
        pageTabItems.insert(LabelText, at: index)
...
extension TabView {
    ...
    fileprivate func updateCurrentIndexForTap(_ index: Int) {
        ...
        self.buttoncurrentindex?.Tabviewbuttontap(currentIndex: index)
