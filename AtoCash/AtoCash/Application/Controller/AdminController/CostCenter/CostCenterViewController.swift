...
class CostCenterViewController: UIViewController {
    ...
    var getCostCenter = [CostCenterDTO]()
    ...
    func getAllCostCenters(){
        ...
        CostCentersAPI.apiCostCentersGetCostCentersGet { (costCenters, error) in
            hideLoader()
            if error == nil {
                self.getCostCenter = costCenters ?? []
    ...
    @IBAction func createAction(_ sender: Any) {
        let vc = adminStoryboard.instantiateViewController(withIdentifier: "CreateCostCenterViewController") as! CreateCostCenterViewController
        vc.editCostCenter = nil
...
extension CostCenterViewController : UITableViewDataSource,UITableViewDelegate, customCellButtonActionDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.lblProductId.text =  " " + getCostCenter[indexPath.row].costCenterCode! + " "
        cell.lblDetailDesc.text = getCostCenter[indexPath.row].costCenterDesc
    ...
    func editActionTag(_ sender: Int) {
        ...
        let vc = adminStoryboard.instantiateViewController(withIdentifier: "CreateCostCenterViewController") as! CreateCostCenterViewController
        vc.editCostCenter = getCostCenter[sender]
        self.navigationController?.pushViewController(vc, animated: true)
    ...
    func deleteCostCenter(deleteCenter : CostCenterDTO){
        
        showLoader()
        CostCentersAPI.apiCostCentersDeleteCostCenterIdDelete(_id: deleteCenter._id!) { (result, error) in
            hideLoader()
            if error == nil {
