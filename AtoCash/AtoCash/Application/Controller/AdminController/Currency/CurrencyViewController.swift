...
class CurrencyViewController: UIViewController {
    ...
    var getCostCenter = [CurrencyTypeDTO]()
    ...
    @IBAction func createAction(_ sender: Any) {
        ...
        let vc = adminStoryboard.instantiateViewController(withIdentifier: "CreateCurrencyViewController") as! CreateCurrencyViewController
    ...
    func getAllCostCenters(){
        showLoader()
        CurrencyTypesAPI.apiCurrencyTypesGetCurrencyTypesGet { (result, error) in
            hideLoader()
            if error == nil {
...
extension CurrencyViewController : UITableViewDataSource,UITableViewDelegate, customCellButtonActionDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       // cell.lblDesc.text = "Approval status type Description"
        cell.lblProductId.text = getCostCenter[indexPath.row].currencyCode
        cell.lblDetailDesc.text = getCostCenter[indexPath.row].country
    ...
    func deleteCostCenter(deleteCenter : CurrencyTypeDTO){
        showLoader()
        CurrencyTypesAPI.apiCurrencyTypesDeleteCurrencyTypeIdDelete(_id: deleteCenter._id!) { (result, error) in
            hideLoader()
            if error == nil {
