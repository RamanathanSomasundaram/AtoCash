//
// ClaimApprovalStatusTracker.swift
//
...
public struct ClaimApprovalStatusTracker: Codable {

    public var _id: Int?
    public var employee: Employee
    public var employeeId: Int?
    public var pettyCashRequest: PettyCashRequest?
    ...
    public init(_id: Int? = nil, employee: Employee, employeeId: Int? = nil, pettyCashRequest: PettyCashRequest? = nil, pettyCashRequestId: Int? = nil, department: Department? = nil, departmentId: Int? = nil, projManager: Employee? = nil, projManagerId: Int? = nil, project: Project? = nil, projectId: Int? = nil, subProject: SubProject? = nil, subProjectId: Int? = nil, workTask: WorkTask? = nil, workTaskId: Int? = nil, approvalGroupId: Int, role: JobRole, roleId: Int? = nil, approvalLevel: ApprovalLevel, approvalLevelId: Int? = nil, reqDate: Date, finalApprovedDate: Date? = nil, approvalStatusType: ApprovalStatusType, approvalStatusTypeId: Int? = nil, comments: String) {
        self._id = _id
        self.employee = employee
        self.employeeId = employeeId
        self.pettyCashRequest = pettyCashRequest
