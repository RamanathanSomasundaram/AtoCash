...
open class ExpenseReimburseStatusTrackersAPI {
  ...
  "approverName" : "approverName"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func apiExpenseReimburseStatusTrackersApprovalsPendingForApproverIdGet(_id: Int, completion: @escaping ((_ data: [ClaimApprovalStatusTrackerDTO]?,_ error: Error?) -> Void)) {
  ...
  "projectId" : 5
     ...
     */
    open class func apiExpenseReimburseStatusTrackersApprovalsPendingForApproverIdGetWithRequestBuilder(_id: Int) -> RequestBuilder<[ClaimApprovalStatusTrackerDTO]> {
    ...
    /**
     ...
     - examples: [{contentType=application/json, example={
  "expenseReimburseRequestId" : 7,
  "workTaskId" : 4,
  "departmentId" : 1,
  "totalClaimAmount" : 1.0246457001441578,
  "approvalStatusTypeId" : 6,
  "employee" : {
    "currencyType" : {
      "country" : "country",
